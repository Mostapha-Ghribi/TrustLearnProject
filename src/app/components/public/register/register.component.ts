...
export class RegisterComponent implements OnInit {
  ...
  register(){
    ...
    let user = new User(undefined, data.firstname, data.lastname, data.email, data.password, data.role, data.file ) ;
    console.log(user);
